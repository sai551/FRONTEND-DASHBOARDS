...
import profileImage from "@/assets/ceo-profile.jpg"; // Profile picture
        ...
        <CardContent className="flex flex-col md:flex-row items-center md:items-start gap-6 p-6">
          ...
          <div className="flex flex-col items-center">
            <Avatar className="h-28 w-28">
              ...
              <AvatarFallback>INTERN</AvatarFallback>
            </Avatar>
          ...
          <div className="flex-1 space-y-2">
            <h2 className="text-2xl font-semibold text-foreground">INTERN</h2>
            <p className="text-muted-foreground">INTERN</p>
            <div className="flex items-center gap-3 text-sm text-muted-foreground">
              <Mail className="h-4 w-4" />INTERN@company.com
            </div>
            <div className="flex items-center gap-3 text-sm text-muted-foreground">
