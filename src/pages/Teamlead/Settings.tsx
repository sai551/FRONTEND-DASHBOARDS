...
export default function TeamSettings() {
  const [profile, setProfile] = useState({
    ...
    role: "Team Lead",
    bio: "Experienced team lead with 8+ years in software development and team management.",
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">Notifications for new leave requests</p>
                  </div>
                  <Switch
