...
import profileImage from "@/assets/image.jpg"; // Profile picture
      ...
      <Card className="shadow-md">
        <CardContent className="flex flex-col md:flex-row items-center md:items-start gap-6 p-6">
          ...
          <div className="flex-1 space-y-2">
            <h2 className="text-2xl font-semibold text-foreground">Trainee</h2>
            <p className="text-muted-foreground">Trainee</p>
            <div className="flex items-center gap-3 text-sm text-muted-foreground">
              <Mail className="h-4 w-4" />trainee@company.com
            </div>
            <div className="flex items-center gap-3 text-sm text-muted-foreground">
