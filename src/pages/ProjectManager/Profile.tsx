        ...
        <CardContent className="flex flex-col md:flex-row items-center md:items-start gap-6 p-6">
          ...
          <div className="flex flex-col items-center">
            <Avatar className="h-28 w-28">
              ...
              <AvatarFallback>PROJECT MANAGER</AvatarFallback>
            </Avatar>
          ...
          <div className="flex-1 space-y-2">
            ...
            <div className="flex items-center gap-3 text-sm text-muted-foreground">
              <Mail className="h-4 w-4" />pm@company.com
            </div>
            <div className="flex items-center gap-3 text-sm text-muted-foreground">
        ...
        <Card className="shadow-md">
          ...
          <CardContent className="space-y-3">
            <div>
              ...
              <Input value="Project Manager" readOnly />
            </div>
            <div>
        ...
        <Card className="shadow-md">
          ...
          <CardContent className="space-y-3">
            ...
            <div>
              ...
              <Input value="Java Developer" readOnly />
            </div>
            <div>
